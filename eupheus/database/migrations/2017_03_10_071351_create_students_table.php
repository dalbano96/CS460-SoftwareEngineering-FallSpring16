...
class CreateStudentsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Students", 'students', 'name', 'fa-group', [
            ["name", "Name", "Name", false, "", 5, 250, false],
            ["gender", "Gender", "Radio", false, "Male", 0, 0, false, ["Male","Female"]],
            ["mobile", "Mobile", "Mobile", false, "", 10, 20, false],
            ["mobile2", "Alternative Mobile", "Mobile", false, "", 10, 20, false],
            ["email", "Email", "Email", true, "", 5, 250, false],
            ["city", "City", "String", false, "", 0, 1000, false],
