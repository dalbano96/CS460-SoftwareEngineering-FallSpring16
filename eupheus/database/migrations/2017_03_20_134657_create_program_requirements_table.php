...
class CreateProgramRequirementsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Program_requirements", 'program_requirements', 'requirements', 'fa-check-square', [
            ["program", "Program", "Dropdown", false, "", 0, 0, false, "@programs"],
            ["requirements", "Requirements", "Dropdown", false, "", 0, 0, false, "@requirements"],
        ]);
    ...
    public function down()
    {
        if (Schema::hasTable('program_requirements')) {
            Schema::drop('program_requirements');
        }
    }
}
