	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $requirement->$view_col }}</h4>
				</div>
			</div>
		</div>
		<div class="col-md-4">
		...
		<div class="col-md-1 actions">
			@la_access("Requirements", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/requirements/'.$requirement->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Requirements", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.requirements.destroy', $requirement->id], 'method' => 'delete', 'style'=>'display:inline']) }}
